...
<table>
    <tr>
        ...
        <td><form action='' method='post'><input type='submit' name='matar' value='Matar!' id="myButton" disabled></form></td>
    </tr>
</table>
        ...
        if (empty($registros_pallets)){
            ...
            if(isset($_POST['matar'])){
                ...
                if($estado!="E"){
                    ...
                    $query_update_codbars="UPDATE produccion_general SET estado ='S', incpallet ='', pedido='0' WHERE codbar_s in $codbars";
                ...
                header("Location: matar.php?pallet=$pallet");
